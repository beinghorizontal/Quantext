...
fig.add_trace(go.Candlestick(x=dfmerge['date'], open=dfmerge['open_list'], high=dfmerge['high_list'],
                             ...
                             close=dfmerge['close_list']))  # candlestick
fig.add_trace(go.Scatter(x=dfmerge.date, y=dfmerge['ad_ratio'], mode='lines'), secondary_y=True)

fig.update_layout(paper_bgcolor='black', plot_bgcolor='black', xaxis=dict(showgrid=False),
